...
class VideoBackSquat: YouTubeBaseActivity()  {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.video)

        intilizePlayer(getYoutubeVideoIdFromUrl("https://www.youtube.com/watch?v=QmZAiBqPvZw&list=PLdWvFCOAvyr3EWQhtfcEMd3DVM5sJdPL4&index=21&ab_channel=CrossFit%C2%AE")!!)
    }
