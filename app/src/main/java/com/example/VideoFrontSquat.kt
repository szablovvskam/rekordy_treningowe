...
class VideoFrontSquat: YouTubeBaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.video)

        intilizePlayer(getYoutubeVideoIdFromUrl("https://www.youtube.com/watch?v=uYumuL_G_V0&list=PLdWvFCOAvyr3EWQhtfcEMd3DVM5sJdPL4&index=11&ab_channel=CrossFit%C2%AE")!!)
    }
