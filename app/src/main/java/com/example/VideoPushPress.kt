...
class VideoPushPress: YouTubeBaseActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.video)

        intilizePlayer(getYoutubeVideoIdFromUrl("https://www.youtube.com/watch?v=iaBVSJm78ko&list=PLdWvFCOAvyr3EWQhtfcEMd3DVM5sJdPL4&index=15&ab_channel=CrossFit%C2%AE")!!)
    }
